...
import static uk.co.digitme.machinemonitoring.Pneumatrol.JobInProgressActivity.JOB_END_DATA_REQUEST_CODE;
import static uk.co.digitme.machinemonitoring.Pneumatrol.SettingInProgressActivity.SETTING_END_DATA_REQUEST_CODE;


/**
 * This activity requests information from the user about a job before ending it
 */
...
public class EndJobActivity extends LoggedInActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pneumatrol_activity_end_job);
